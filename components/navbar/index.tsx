...
const Navbar = () => {
  return (
    <header>
      <nav className="flex items-center justify-between py-5 px-4 md:px-16 lg:px-24 border-b dark:border-b-slate-800 border-b-slate-300 dark:bg-slate-900/85 bg-slate-200/85">
